...
def run_ablation_experiment(
    ...
    """
    Ablates the factors of RevisionScore:
    R = w1 * Sim + w2 * StateCompat + w3 * TemporalCompat + w4 * ProvenanceCompat
    and tests sensitivity to theta_trigger and theta_restore.
    """
    ...
    engine = RevisionEngine(
        RevisionConfig(
            w_sim=w1,
            w_state_compat=w2,
            w_temporal_compat=w3,
            w_provenance_compat=w4,
            theta_trigger=theta_trigger,
            theta_restore=theta_restore,
